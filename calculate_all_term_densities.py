...
def plot_density_heatmap(density_matrix, terms, output_path="images/all_term_densities_heatmap.png"):
...
def main():
    ...
    # Plot heatmap
    # Replace 'russian' with 'slavic' for the heatmap visualization
